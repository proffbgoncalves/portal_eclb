...
///
/// See the documentation for Mockito's code generation for more information.
class MockNotablePersonDAO extends _i1.Mock implements _i10.NotablePersonDAO {
  MockNotablePersonDAO() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i11.Future<_i15.NotablePerson?> findByPatrimonyPersonId(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #findByPatrimonyPersonId,
          [id],
        ),
        returnValue: _i11.Future<_i15.NotablePerson?>.value(),
      ) as _i11.Future<_i15.NotablePerson?>);
...
class MockVisitationStageDAO extends _i1.Mock
  ...
  @override
  _i11.Future<_i16.VisitationStage?> findByid(int? id) => (super.noSuchMethod(
        Invocation.method(
          #findByid,
          [id],
        ),
        returnValue: _i11.Future<_i16.VisitationStage?>.value(),
      ) as _i11.Future<_i16.VisitationStage?>);

  @override
  _i11.Future<List<dynamic>> findAllByName(String? name) => (super.noSuchMethod(
        Invocation.method(
          #findAllByName,
          [name],
        ),
  ...
  @override
  _i11.Future<_i16.VisitationStage?> findByVisitationItineraryId(
